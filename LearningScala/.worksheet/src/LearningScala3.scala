object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  def getUpper(s: String): String = {
  s.toUpperCase
  };System.out.println("""getUpper: (s: String)String""");$skip(33); 
  println(getUpper("sadJJ23sd"));$skip(77); 
  
  def changeString(s: String, f: String => String): String = {
  f(s)
  };System.out.println("""changeString: (s: String, f: String => String)String""");$skip(52); val res$3 = 
  changeString("asdsad734dsGF", s => s.toUpperCase);System.out.println("""res3: String = """ + $show(res$3))}
