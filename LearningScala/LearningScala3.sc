object LearningScala3 {
  ...
  s.toUpperCase
  }                                               //> getUpper: (s: String)String
  println(getUpper("sadJJ23sd"))                  //> SADJJ23SD
  
  def changeString(s: String, f: String => String): String = {
  f(s)
  }                                               //> changeString: (s: String, f: String => String)String
  changeString("asdsad734dsGF", s => s.toUpperCase)
                                                  //> res3: String = ASDSAD734DSGF
