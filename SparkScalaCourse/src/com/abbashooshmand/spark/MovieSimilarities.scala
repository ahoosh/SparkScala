package com.abbashooshmand.spark
...
// 3) Adjust the threshholds for minimum co-raters or minimu score
// 4) Invent a new similarity metric that takes the number of co-raters into account
// 5) Use genre info in u.items to boost scores from movies in the same genre